...
#
#  Face Maps Legacy, (c) 2024 Tyo 790000000000000000000000
#
...
bl_info = {
    "name": "Face Maps Legacy",
    "author": "Tyo79 with contribution from Michel Anders (varkenvarken)  Andrew Leichter (aleichter)",
    "version": (0, 0, 3),
    "blender": (4, 2, 0),
    "location": "Edit mode 3d-view, Select- -> From facemap | Create facemap",
    "description": "Create, Delete, Assign, Remove, Select, Deselect, FaceMaps to Face Selection ",
    "warning": "",
